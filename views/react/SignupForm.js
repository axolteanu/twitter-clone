...
export function SignupForm(props){
  ...
  return(
    <ModalForm id="modal-form" formRef={props.formRef} title="Create your account" className="signup-modal-form" action="/signup" submit={submit} onSubmit={props.onSubmit}>
      <div>
